...
namespace TortoiseSCM
{
    internal sealed class MergeForm : Form
    {
        ...
        public MergeForm(PlasticClient client, string root)
        {
            ...
            top.Controls.Add(source); top.Controls.Add(preview); top.Controls.Add(start); top.Controls.Add(resume);
            ...
            prepare.Width = apply.Width = 115;
            footer.Controls.Add(close); footer.Controls.Add(apply); footer.Controls.Add(prepare); layout.Controls.Add(footer, 0, 4);
            Controls.Add(layout);
        ...
        private void UpdateButtons()
        {
            ...
            resume.Enabled = !busy;
            start.Enabled = !busy && session == null && plan != null && !plan.AlreadyConnected && plan.DirectoryConflicts.Count == 0;
            prepare.Enabled = apply.Enabled = !busy && session != null && selected != null && !selected.Resolved;
        }
